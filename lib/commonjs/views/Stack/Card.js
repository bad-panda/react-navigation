...
class Card extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "interactionHandleAnim", void 0);
    ...
    _defineProperty(this, "handleStartAnimationInteraction", () => {
      if (this.interactionHandleAnim === undefined) {
        console.log('handleStartAnimationInteraction - create handle');
        this.interactionHandleAnim = _reactNative.InteractionManager.createInteractionHandle();
      }
    });

    _defineProperty(this, "handleEndAnimationInteraction", () => {
      if (this.interactionHandleAnim !== undefined) {
        console.log('handleEndAnimationInteraction - clear handle');

        _reactNative.InteractionManager.clearInteractionHandle(this.interactionHandleAnim);
