...
import { View, Platform, StyleSheet, InteractionManager, Handle } from 'react-native';
...
export default class StackView extends React.Component<Props, State> {
  ...
  private interactionHandle?: Handle;
  ...
  private handleTransitionStart = (
    ...
    console.log('StackView - transitionStart');
  ...
  private handleTransitionEnd = (
    ...
    console.log('StackView - transitionEnd');
